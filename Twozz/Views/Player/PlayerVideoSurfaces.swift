...
/// AVPlayer host that is intentionally non-interactive: Twozz handles all remote
...
/// This keeps custom Twozz UI while preserving Apple's media rendering paths
...
struct VideoSurface: UIViewControllerRepresentable {
  ...
  func makeUIViewController(context: Context) -> AVPlayerViewController {
    ...
    // Remote input (seek/scrub/skip). Twozz UI remains fully interactive.
