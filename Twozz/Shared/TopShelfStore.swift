...
enum TopShelf {
    ...
    /// Custom URL scheme Twozz registers for deep links.
    static let deepLinkScheme = "twozz"

    /// Deep-link host used for "open this channel" links.
    static let channelHost = "channel"

    /// Builds the deep link that launches Twozz straight into a channel.
    /// Example: `twozz://channel/pokimane`.
